...
public class Constants {
    ...
    //    conexão principal
    private static final String ROOT_URL = "http://10.133.96.13:8080/cpfl/v1/";
    ...
    private static final String ROOT_FATURAS = "fatura/";
...
//    acessando os métodos de POST e GET utilizando ROOT_URL + ROOT_USERS ou ROOT_NEWS e o restante to path em ""
    ...
    public static final String URL_GET_FATURAS = ROOT_URL+ROOT_FATURAS+"getAllFaturas.php";
}
